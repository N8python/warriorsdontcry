const data = {
    "People": [{
            ...
            body: `
        <p>Born on Pearl Harbor Day, December 7, 1941, Melba grew up in Little Rock Arkansas with her father, Howell, her mother, Lois, her brother, Conrad, and her grandma, India.  Melba is the author and main protagonist of <em>Warriors Don't Cry</em>, and a starkly dynamic character throughout the book.</p>

    <p>Initially, Melba is optimistic about the results of integration, hoping that the white racists will change their opinions upon seeing that Melba is a genuinely good person who means no harm. Upon arrival however, The Little Rock Nine are heckled ruthlessly, and a group of crazed white men chase and attempt to hang Melba. During Melba's first day at school, she is teased and abused (both physically and verbally) by both students and teachers.</p>
    ...
    <p>After the events of the book, Melba graduated from San Francisco State University and went on to earn and master's degree in journalism and she promptly became a journalist. She married John Beals, and they had one daughter before getting divorced. Today, Melba remains a journalist and is the retired chairman of the Dominican University of California's Communications Department. She will be forever honored for her bravery in the integration of Central High, and for her contribution to the Civil Rights movement.</p> 
        `
        }, {
            name: "Conrad Patillo",
            alias: "Conrad",
        ...
        },
        {
            name: "Howell Patillo",
            alias: "Howell",
            body: "<p> Melba's father, Howell, is present for the early years of Melba's life, before her parents get divorced when Melba is seven, due to Howell's refusal to return to school to complete one final university course. Howell is a strong, stout man who Melba initially admires as a father figure. One of Melba's first exposures to segregation was in Mr. Waylan's grocery store, where Melba's family was overcharged twenty-two dollars (several hundred dollars in today's money). Melba's father, though he was stronger, taller, and more powerful than old decrepit white man running the cashier, couldn't stand up for his family out of fear of the repercussions. Once her parents get divorced, Howell still visits on occasion, and Melba hopes for a few years that her parents will get back together, before she finally accepts the fact of their separation.</p>"
        },
        {
            name: "Mother Lois",
            alias: "Lois",
        ...
        },
        {
            ...
            body: `<p>Ernest Green, one of only two little rock nine members to graduate from Central High, plays a minor role in <em>Warriors Don't Cry</em>. He is described as having "warm eyes" and a "quick smile", and is shown throughout the book to be optimistic even when things seem hopeless. He's so charismatic that even when Melba disagrees with him she says she "likes his attitude". He testifies in court to defend integration (along with Elizabeth Eckford) and with the help of Thurgood Marshall and Wiley Branton, The Little Rock Nine win the case. At the end of the Book, Ernest Green finally graduates from Central High, and he is invited up onto the podium to recieve his diploma, but nobody claps for him.</p></body>`
        }, {
          ...
          <p>Later in the year, Minnijean is expelled from Central High due to a series of "incidents", none of which were initiated by Minnijean. The first incident occurs (The "Minnijean Chili Scene") when Minnijean is being harassed and pushed around by two white boys at lunch, and she is so fed up with not being allowed to defend herself from her white tormentors that she drops her chili she is carrying on the boy's heads, and she is promptly suspended for six days. Then, in February, a group of racist white students launch a coordinated attack on Minnijean, and to retaliate, she rightfully calls the girls "white trash". She is promptly expelled. This leads to the circulation of the message "One down, eight to go." in Central High. Minnijean attends New Lincoln School in New York for the remainder of her high school education and goes to college at Southern Illinois University, before studying social work and ultimately working at the Clinton Administration.</p>`
            ...
            name: "Gloria Ray",
            body: `<p>Gloria Ray, a member of Melba's Sunday School class, was "as meticulous about her attire as she was about her studies." Based of her description in <em>Warriors Don't Cry</em>, she is obviously incredibly intelligent and eloquent, however the entirety of her character is never explored. She later graduated from the Illinois Institute of Technology before moving to Sweden, where she took up work as a patent attorney. She founded the journal <em>Computers in Industry</em>, where she worked for 18 years. Just one year ago, she was awarded an Honorary Doctorate of Science for "outstanding contributions to the development of a more inclusive society from the Illinois Institute of Technology."</p>`
        }, {
            name: "Vince",
            quote: "I want you to be my girlfriend.",
            body: `<p>In the beginning of <em>Warriors Don't Cry</em>, Melba daydreams about becoming Vince's girlfriend consistentently. Several chapters in, her dreams become a reality when Vince flat-out asks her to be his girlfriend. Their first date goes well, with Melba accompanying Vince to church and lunch, and concludes with Vince and Melba having dinner with the entirety of Melba's family. When no one else shows up to Melba's birthday party out of fear that Melba's house will be attacked, Vince attends and gives Melba "tiny gold hoop earings". Vince later becomes a regular guest Melba's family's Sunday dinners.</p>
            <p>Though their relationship gets off to a good start, Melba gets so caught up in the integration of Central High that she gradually begins to feel like doesn't have time for a boyfriend. Soon, she feels that her trials in the integration of Central High, and her quest for equality in general seperate her from Vince, and she begins to stop returning his calls. By the end of the book, she has peacefully seperated herself from Vince without a big confrontation.</p>`
        }, {
            name: "Dwight D. Eisenhower",
            quote: `Whatever America hopes to bring to pass in the world must first come to pass in the heart of America."`,
            body: `<p>Born in 1953, Eisenhower quickly showed himself to be a leader. He commanded Operation Torch in WWII and later oversaw all of West Germany for a few years. He ran for president in 1952, and won in a landslide. With civil rights being one of his principle ideas, he was quick to order a meeting with Governor Faubus of Arkansas when Faubus refused to comply with <em>Brown vs. Board of Education</em>. Faubus agreed to integration in the meeting, but then turned a blind eye to a massive mob outside of Central High preventing the Little Rock Nine from entering, before sending the Arkansas National Guard in to "keep the peace". However, the Arkansas National Guard did more harm then good, so Eisenhower stepped in again and sent the 101st Airborne Division to protect the Little Rock Nine. The Screaming Eagles significantly lessened the taunting and abuse at Central High for the Little Rock Nine, though the help they could offer was limited. Inevitably, the 101st had to leave (to show that integration in Little Rock could be successful without military force), and when they did, The Little Rock Nine was exposed to more harrasment and abuse than ever before.</p>`
        }, {
            name: "Mrs. Huckaby",
            ...
            <p>However, the 101st is effective is drastically reducing the torment dished out by the segregationists. However, once everything seems as if it has settled down, Eisenhower attempts to pull the 101st out of Little Rock. The moment the 101st vacates Central High, attacks by segregationists sore to such a height that the 101st returns to Little Rock. They defend the Little Rock Nine for some time, but eventually, they are forced to go - as the integration wouldn't really have been a success if it required military force to uphold. Once they leave for good, attacks on the Little Rock Nine reach unprecedented levels.</p>`
        }, {
            name: "Arkansas National Guard",
            body: `<p>When the mob at Central High gets out of hand, the Arkansas National Guard are called in to "keep the peace". However, they don't prevent the relentless harrasment and beating of the Little Rock Nine by the massive mob. Later on, The Arkansas National Guard turn a blind eye to virtually all abuse the Little Rock Nine receive in Central High. Even when they are assigned to <em>specifically guard members of the Little Rock Nine</em> they ultimately stand by while taunts and kicks are flung at the people they're supposed to be guarding. On multiple occasions, Melba's guard would stand by aloofley while white students beat her again and again. In some instances, crazed segregationists bribe their way past the Arkansas National Guard to attack the Little Rock Nine. The Arkansas National Guard were too inactive and too biased toward the segregationists to make an effective peacekeeping and defensive force.</p>`
        }, {
            name: "Danny",
            quote: `It’s never too late. It takes a warrior to fight a battle and survive. This here is a battle if I’ve ever seen one.`,
            body: `<p>Danny was the member of the Screaming Eagles assigned to guard Melba. He intimidated some students and his presence alone reduced the harrasment. Nevertheless, students still tried to tease, abuse, and even kill Melba when Danny wasn't there (they tried to burn her alive in a bathroom stall). However, when Danny was there, protecting Melba was his top priority (unlike the Arkansas National Guard).</p>
            ...
            body: `<p>Born in 1961, Obama would go on to become the first ever African-American president of the United States. During his presidency, he made America a more liberal, more accepting place in general. He supported the LGBTQ+ movement and was the first president to openly approve of and vouch for same-sex marriage. He helped America recover from the Great Reccession by passing revolutionary economic policies. Obama also began to take action against pollution and climate change when he prevented unsafe drilling from causing any more oil spills. One of his most significant achievements was the Affordable Care Act, also known as "Obamacare", which significantly reduced the cost of health insurance in America.</p>`
        }, {
